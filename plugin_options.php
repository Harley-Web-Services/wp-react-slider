...
class WP_React_Slider_Options {
  ...
  */
  ...
  public function register_plugin_settings() {
      register_setting( 'wp-react-slider-settings-group', 'wp-react-slider' );
  }
  ...
  */
  public function create_admin_menu_page() {
    $this->plugin_options_page = add_options_page('WP React Slider', 'WP React Slider', 'manage_options', __FILE__, array( $this, 'render_plugin_options_page' ) );
  }

  public function render_plugin_options_page() {
    echo '<div class="wp-react-slider"></div>';
  }
...
$wp_react_plugin_options = new WP_React_Slider_Options();
$wp_react_slider_options->init();